...
read region_name
mysql --host=127.0.0.1 --port=3306 -uroot -p1987429a -e "
use dragonlogindata;
...
mysql --host=127.0.0.1 --port=3306  -p1987429a < structure.sql

#echo "import gift code" 
#mysql --host=127.0.0.1 --port=3306  -p1987429a < giftcodesum.sql 
