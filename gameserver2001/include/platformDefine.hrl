...
-define(PLATFORM_TT, 142). %% TT 广州宜游科技 支付时用的143、所以142、143都为tt
...
-define(PLATFORM_AiYouXi, 149). %% 爱游戏

-define(PLATFORM_FAST_LOGIN, 250). %% 快速登录

-define(PLATFORM_SIFU_DAMAI, 193). %% sf 大麦
-define(PLATFORM_SIFU_195_1, 194).%% sf 5k+ 测试
-define(PLATFORM_SIFU_195, 195). %% sf 5k+
...
-define(UC_Officially_ServerID, 2717).
...
%% 当乐
-define(DL_APP_ID, 1405).
-define(DL_APP_KEY, "dKvs272U").

%% 小米
-define(MI_APP_ID, "25326").
-define(MI_APP_KEY, "a41567cf-d81e-9c8d-b223-535617e4c2b7").
-define(MI_APP_Secret, "zzXhSHOZEacFnFfQHAGAiw==").

%% 360
-define(QH_APP_ID, "201457671").
-define(QH_APP_KEY, "53e83c6618e0fbfc83487018718609bc").
-define(QH_APP_Secret, "d40993797be78599340dc64ffb2ad26c").

%% 豌豆荚
-define(Peasecod_APP_ID, "100001537").
-define(Peasecod_APP_KEY, "774b4fe7aa258bdf365ed3f833e5a7a9").
...
%% OPPP
-define(APP_ID_OPPO, "1651").
-define(APP_KEY_OPPO, "Aj9GWDDgk3S48488S4oc0ck0W").
-define(APP_Secret_OPPO, "3F6Af6531Ad6C3d14e57868656B9d9bF").
